...
Original file is located at
    https://colab.research.google.com/drive/19lRp1FOqYgNFatD0BVsrQoUdEXhM2YpG
"""
...
# After all your training, SMOTE, and evaluation is done
# Save the trained vectorizer and model as pickle files

import pickle

# Save the vectorizer you created earlier (vec)
with open('vectorizer.pkl', 'wb') as f:
    pickle.dump(vec, f)  # This should be your fitted vectorizer

# Save the trained model (mnb)
with open('emotion_model.pkl', 'wb') as f:
    pickle.dump(mnb, f)  # This is your trained model
